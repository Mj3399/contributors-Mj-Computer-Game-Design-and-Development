...
public class Spawner : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(Time.time > SpawnNow)
        {

            SpawnNow = SpawnNow + SpawnInterval;
            var enemy = Instantiate(Prefab, SpawnUtilities.RandomFreePoint(FreeRadius), Quaternion.identity);
