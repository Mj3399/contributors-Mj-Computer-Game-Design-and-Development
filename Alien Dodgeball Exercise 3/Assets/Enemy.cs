...
public class Enemy : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            shootnow = shootnow + CoolDownTime;
            Fire();
...

    {
        ...
        Vector3 v3 = HeadingToPlayer;
        var orbb = Instantiate(OrbPrefab, transform.position + v3 , Quaternion.identity);
        Rigidbody2D oRB = orbb.GetComponent<Rigidbody2D>();
        oRB.velocity = OrbVelocity * HeadingToPlayer;
        oRB.mass = OrbMass;
