...
public class BarGraph : MonoBehaviour
{
    ...
    public void SetWidthPercent(float value, Color c)
    {
        ...
        if (signedDisplay)
        {
            BarTransform.localScale = new Vector3(value / 2, BarTransform.localScale.y);
    ...
    public static BarGraph Find(string name, Vector2 position, float min, float max)
    {
        ...
        BarGraph bgComponent = go.GetComponent("BarGraph") as BarGraph;  // Change null here
